...
//var_dump($this->request->post['selected']);
		if (isset($this->request->post['selected']) && $this->validateDelete()) {
			foreach ($this->request->post['selected'] as $news_id) {
				$this->model_common_newsletter->deleteNewsletter($news_id);
			}
			...
			$this->response->redirect($this->url->link('common/newsletter', 'token=' . $this->session->data['token'] . $url, true));
		}
	...
	protected function getList() {
		...
		$data['cancel'] = $this->url->link('common/newsletter', 'token=' . $this->session->data['token'], true);
		$data['delete'] = $this->url->link('common/newsletter/delete', 'token=' . $this->session->data['token'] . $url, true);
		...
		$data['sort_name'] = $this->url->link('common/newsletter', 'token=' . $this->session->data['token'] . '&sort=name' . $url, 'SSL');
		$data['sort_town'] = $this->url->link('common/newsletter', 'token=' . $this->session->data['token'] . '&sort=sort_town' . $url, 'SSL');
		...
		if (!$this->user->hasPermission('modify', 'common/newsletter')) {
