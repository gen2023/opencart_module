				...
				<div class="panel-body">
					<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data"
						...
						<ul class="nav nav-tabs">
							...
							<li><a href="#tab-sliderEvents" data-toggle="tab"><?php echo $tab_sliderEvents; ?></a></li>
						...
						<div class="tab-content">
							...
							<div  class="tab-pane" id="tab-sliderEvents">
							    <div class="form-group">
								...
								<div class="form-group">
							  	...
							  	<div class="form-group">
									<label class="col-sm-4 control-label" for="input-event-slider"><?php echo $entry_sliderEvents; ?></label>
									<div class="col-sm-4">
										<select name="slider" id="input-event-slider" class="form-control">
											<?php if ($slider) { ?>
											<option value="1" selected="selected"><?php echo $text_yes; ?></option>
											<option value="0"><?php echo $text_no; ?></option>
											<?php } else { ?>
