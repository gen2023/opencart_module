<<<<<<< HEAD
<?php  
class ControllerExtensionModuleCountUserNews extends Controller {
	public function index() {
		...
		if ($this->config->get('module_count_user_status')){
			...
			$flag=0;
			$item_id = $this->request->get['news_id'];
			$results=$this->model_extension_module_count_user->getUserNews($item_id);
			...
			if ($flag!=1){
				$this->model_extension_module_count_user->addUserNews($current_user,$nowTime,$item_id);
			}
