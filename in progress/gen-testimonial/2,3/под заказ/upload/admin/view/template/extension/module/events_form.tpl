					...
					<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-events" class="form-horizontal">
						...
						<div class="tab-content">
								...
								<div class="tab-content">
									...
									<div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
										<div class="form-group">
											<label class="col-sm-2 control-label" for="input-title1<?php echo $language['language_id']; ?>"><?php echo $entry_title1; ?></label>
											<div class="col-sm-10">
												<input type="text" name="events_description[<?php echo $language['language_id']; ?>][title1]" value="<?php echo isset($events_description[$language['language_id']]) ? $events_description[$language['language_id']]['title1'] : ''; ?>" placeholder="<?php echo $entry_title1; ?>" id="input-title1<?php echo $language['language_id']; ?>" class="form-control" />
											</div>
										</div>
										<div class="form-group required">
											<label class="col-sm-2 control-label" style="font-size: 13px;" for="input-title<?php echo $language['language_id']; ?>"><?php echo $entry_title; ?></label>
											<div class="col-sm-10">
										...
										<div class="form-group">
											<label class="col-sm-2 control-label" for="input-title3<?php echo $language['language_id']; ?>"><?php echo $entry_title3; ?></label>
											<div class="col-sm-10">
												<input type="text" name="events_description[<?php echo $language['language_id']; ?>][title3]" value="<?php echo isset($events_description[$language['language_id']]) ? $events_description[$language['language_id']]['title3'] : ''; ?>" placeholder="<?php echo $entry_title3; ?>" id="input-title<?php echo $language['language_id']; ?>" class="form-control" />
											</div>
										</div>
										<div class="form-group required">
							...
							<div class="tab-pane" id="tab-data">
								...
								<div class="form-group">
									<label class="col-sm-2 control-label" for="input-time-to"><?php echo $entry_time_to; ?></label>
									<div class="col-sm-6">
								...
								<div class="form-group">
									<label class="col-sm-2 control-label" for="input-time-from"><?php echo $entry_time_from; ?></label>
									<div class="col-sm-6">
										<div class="input-group time">
								...
								<div class="form-group">
									<label class="col-sm-2 control-label" for="input-event_price"><?php echo $entry_event_price; ?></label>
									<div class="col-sm-10">
										<input type="text" name="event_price" value="<?php echo $event_price; ?>" placeholder="<?php echo $entry_event_price; ?>" id="input-event_price" class="form-control" />
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-2 control-label" for="input-additional_field"><?php echo $entry_additional_field; ?></label>
									<div class="col-sm-10">
										<input type="text" name="additional_field" value="<?php echo $additional_field; ?>" placeholder="<?php echo $entry_additional_field; ?>" id="input-additional_field" class="form-control" />
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-2 control-label" for="input-doctor"><span data-toggle="tooltip" title="<?php echo $help_doctor; ?>"><?php echo $entry_event_doctor; ?></span></label>
									<div class="col-sm-10">
									  <input type="text" name="event_doctor" value="" placeholder="<?php echo $entry_event_doctor; ?>" id="input-doctor" class="form-control" />
										<div id="featured-doctor" style="height: 150px; overflow: auto;">
											<?php if ($doctor) {?>
											<div id="featured-doctor<?php echo $doctor['doctor_id']; ?>"><i class="delDoctor fa-minus-circle"></i> <?php echo $doctor['title']; ?><image src="<?php echo $doctor['image']; ?>">
													<input type="hidden" name="doctor[]" value="<?php echo $doctor['doctor_id'];?>" />
											</div>
											<?php } ?>
									  </div>
									</div>
...
//--></script>
	  <script type="text/javascript"><!--
$('input[name=\'event_doctor\']').autocomplete({

	source: function(request, response) {
		
		$.ajax({
			url: 'index.php?route=extension/module/events/autocompleteDoctors&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {
	...
	select: function(item) {
		...
		$('input[name=\'event_doctor\']').val('');
		
		$('#featured-doctor' + item['value']).remove();
		
		$('#featured-doctor').html('<div id="featured-doctor' + item['value'] + '"><i class="delDoctor fa-minus-circle"></i> ' + item['label'] +'<img src="'+item['image']+'" alt="">'+ '<input type="hidden" name="doctor[]" value="' + item['value'] + '" /></div>');	
	}
});
	
$('#featured-doctor').delegate('.fa-minus-circle', 'click', function() {
	$(this).parent().remove();
});
//--></script>
</div>
