...
// Text
$_['text_feedGoogle']        = 'Каналы продвижения google';
$_['text_feedFacebook']        = 'Каналы продвижения facebook';
$_['text_feedInstagram']        = 'Каналы продвижения instagram';
$_['text_success']     = 'Настройки модуля Простой YML успешно сохранены!';
$_['text_edit']        = 'Редактирование модуля Мультиязычная карта сайта XML';
...
<p><a target="_blank" href="https://opencartbot.com/ru/simple-yml">Страница модуля</a></p>
...
// Error
$_['error_permission'] = 'Внимание: У вас недостаточно прав для изменения модуля Простой YML!';