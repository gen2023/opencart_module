					...
					<div class="eventItem">
						...
						<div>
							<div class="caption" style="margin-left:50px">
								<i><?php echo $event_date_to; ?><?php echo $events_item['date_to']; ?>
								<?php echo $event_date_from; ?><?php echo $events_item['date_from']; ?> (<?php echo $events_item['time_to']; ?> - <?php echo $events_item['time_from']; ?>)</i><br>
