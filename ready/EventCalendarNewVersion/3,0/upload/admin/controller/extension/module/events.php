...
class ControllerExtensionModuleEvents extends Controller {
	...
	private function getList() {
		...
		if ($events_setting){
			...
			$data['hideEvent'] = $this->url->link('extension/module/events/hideEvent', 'user_token=' . $this->session->data['user_token'] . $url, true);
		}else{
			$data['add'] = $this->url->link('extension/module/events', 'user_token=' . $this->session->data['user_token'], true);
			$data['delete'] = $this->url->link('extension/module/events', 'user_token=' . $this->session->data['user_token'], true);
			$data['copy'] = $this->url->link('extension/module/events', 'user_token=' . $this->session->data['user_token'] . $url, true);
			$data['hideEvent'] = $this->url->link('extension/module/events', 'user_token=' . $this->session->data['user_token'] . $url, true);
	...
	private function getForm() { 
		...
		if (!$event_value){
			$data['error_warning'] = $this->language->get('error_license_setting');
			$data['action'] = $this->url->link('extension/module/events', 'user_token=' . $this->session->data['user_token'], true);
		} else {
