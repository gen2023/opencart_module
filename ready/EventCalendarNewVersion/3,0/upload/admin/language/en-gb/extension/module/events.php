...
$_['text_success_view']			= 'Successfully modified %s events!';
$_['text_list']					= 'Events List';
$_['text_add']					= 'Add Event';
$_['text_edit']					= 'Edit Event';
$_['text_plus']					= '+';
$_['text_minus']				= '-';
$_['text_license']				= 'To get the key, send a message to e-meil: <b> gen2023@yandex.ru</b>, <b>genodessa@gmail.com</b>';
$_['text_events_setting']		= 'Global event settings';
$_['text_editNameRightMenu'] 	= 'Change the names of the items of the right menu';
$_['text_repeat_day']			= 'Repeat once a day';
$_['text_repeat_week']			= 'Repeat once a weekю';
$_['text_repeat_month']			= 'Repeat once a month';
$_['text_repeat_year']			= 'Repeat once a year';
$_['text_repeat_no']			= 'Do not repeat';
...
$_['error_license_setting'] 	= 'To set the key, click the settings button!';
$_['error_setting_viewRightMenu']= 'Enter Right Menu View Items!';

$_['button_setting']			= 'Settings';
$_['button_hideEvent']			= 'Disable past events';