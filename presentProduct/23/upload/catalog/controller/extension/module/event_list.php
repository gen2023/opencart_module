...
class ControllerExtensionModuleEventList extends Controller {
	...
	public function index(){
		...
		$data['sorts'][] = array(
			...
			'href' => $this->url->link('extension/module/event_list', 'sort=n.date_from&order=ASC' . $url)
		);

		$data['sorts'][] = array(
			'text' => $this->language->get('text_date_desc'),
			'value' => 'n.date_from-DESC',
			'href' => $this->url->link('extension/module/event_list', 'sort=n.date_from&order=DESC' . $url)
		);		
