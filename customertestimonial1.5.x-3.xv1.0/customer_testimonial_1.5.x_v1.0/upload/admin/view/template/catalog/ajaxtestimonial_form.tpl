							...
							<table class="form">
									...
									<tr>
										...
										<td>
											...
											<textarea rows="10" cols="95" name="ajaxtestimonial_description[<?php echo $language['language_id']; ?>][description]" id="description<?php echo $language['language_id']; ?>"><?php echo isset($ajaxtestimonial_description[$language['language_id']]) ? $ajaxtestimonial_description[$language['language_id']]['description'] : ''; ?></textarea>
