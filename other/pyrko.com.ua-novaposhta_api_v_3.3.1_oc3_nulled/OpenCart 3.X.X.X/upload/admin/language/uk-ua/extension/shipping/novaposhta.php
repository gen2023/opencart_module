<?php
// Heading
$_['heading_title']    						 = 'Нова Пошта API <a href="http://NoMoney.su" target="_blank" title="NoMoney.su" style="color:#0362B6;margin-right:5px"><i class="fa fa-cloud-download fa-fw"></i></a> ';
