...
$_['text_gallery_setting']             = 'Глобальные настройки события';
...
$_['column_date_from']            = 'Дата начала события';
$_['column_date_to']            = 'Дата конца события';
...
$_['entry_gallery_url']       = 'Введите URL для страницы календаря:';
$_['entry_gallerylist_url']   = 'Введите URL для страницы списка событий:';
