...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			if ($this->user->hasPermission('access', 'catalog/reviewReply')) {		
				$catalog[] = array(
					'name'	   => $this->language->get('Отзывы на коменты'),
					'href'     => $this->url->link('catalog/reviewReply', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);		
			}

            if ($this->user->hasPermission('access', 'catalog/m_testimonial')) {
                $catalog[] = array(
                    'name'	   => $this->language->get('Отзывы о мастерах'),
                    'href'     => $this->url->link('catalog/m_testimonial', 'user_token=' . $this->session->data['user_token'], true),
                    'children' => array()
                );
            }
            ...
            $works = array();
            $works[] = array(
                'name'	   => $this->language->get('text_works_category'),
                'href'     => $this->url->link('works/category', 'user_token=' . $this->session->data['user_token'], true),
                'children' => array()
            );
            $works[] = array(
                'name'	   => $this->language->get('text_works_work'),
                'href'     => $this->url->link('works/work', 'user_token=' . $this->session->data['user_token'], true),
                'children' => array()
            );
            $data['menus'][] = array(
                'id'       => 'menu-works',
                'icon'	   => 'fa-cog',
                'name'	   => $this->language->get('text_works'),
                'href'     => '',
                'children' => $works
            );
            ...
            $moderation = array();
            $moderation[] = array(
                'name'	   => $this->language->get('text_moderation_offers'),
                'href'     => $this->url->link('moderation/offer', 'user_token=' . $this->session->data['user_token'], true),
                'children' => array()
            );
            $moderation[] = array(
                'name'	   => $this->language->get('text_moderation_posts'),
                'href'     => $this->url->link('moderation/post', 'user_token=' . $this->session->data['user_token'], true),
                'children' => array()
            );
            $moderation[] = array(
                'name'	   => $this->language->get('text_moderation_masters'),
                'href'     => $this->url->link('moderation/master', 'user_token=' . $this->session->data['user_token'], true),
                'children' => array()
            );
            $data['menus'][] = array(
                'id'       => 'menu-works',
                'icon'	   => 'fa-cog',
                'name'	   => $this->language->get('text_moderation'),
                'href'     => '',
                'children' => $moderation
            );
			
			// Stats
			/* IMReport Start */			if ($this->user->hasPermission('access', 'extension/module/IMReport')) {
				$data['menus'][] = array(
					'id'       => 'menu-report-imreport',
					'icon'	   => 'fa-bar-chart-o',
					'name'	   => 'IMReport (OC 3)',
					'href'     => $this->url->link('extension/module/IMReport', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}/* IMReport End */$this->load->model('sale/order');
